		...
		template.innerHTML = `
			<style>
				...
				* { box-sizing: border-box; }
				...
				.edac-highlight-panel-visible { width: 400px; }
				...
				.edac-highlight-panel-controls-summary { display: block; margin-bottom: 10px; }
				...
				.edac-highlight-panel-controls-buttons button:disabled { display: none; }

				.edac-highlight-disable-styles { float: right; margin-right: 0; }
				...
				.edac-highlight-panel-description-type-error { color: #fff; background-color: #dc3232; }
				.edac-highlight-panel-description-type-warning { color: #072446; background-color: #ffb900; }
				.edac-highlight-panel-description-type-ignored { color: #fff; background-color: #0073aa; }
