	...
	public static function get_rule(): array {
		return [
			...
			// translators: %1$s is <code>&lt;h1&gt;</code>, %2$s is <code>&lt;h6&gt;</code.
				esc_html__( 'Review the flagged text and determine if it should be a heading. If it is, change the element to the appropriate %1$s–%2$s tag. If it is not intended as a heading, you can dismiss this warning in Accessibility Checker.', 'accessibility-checker' ),
				'<code>&lt;h1&gt;</code>',
				'<code>&lt;h6&gt;</code>'
			),
			'references'            => [
