	...
	public function filter_by_value_data() {
		return [
			...
			'numeric value matching' => [
				'items'    => [
					[ 'priority' => 1, 'task' => 'High priority task' ],
					[ 'priority' => 2, 'task' => 'Medium priority task' ],
					[ 'priority' => 1, 'task' => 'Another high priority' ],
				],
				'index'    => 'priority',
				'value'    => 1,
				'expected' => [
			...
			'string value with special characters' => [
				'items'    => [
					[ 'url' => 'example.com', 'type' => 'external' ],
					[ 'url' => '/internal-page', 'type' => 'internal' ],
					[ 'url' => 'mailto:test@example.com', 'type' => 'email' ],
				],
				'index'    => 'type',
				'value'    => 'external',
				'expected' => [
